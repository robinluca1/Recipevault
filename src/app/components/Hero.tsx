      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-amber-100 border border-amber-200 rounded-full w-fit">
            ...
            <span className="text-amber-700" style={{ fontSize: "0.8125rem", fontWeight: 500 }}>
              Loved by 10,000+ home cooks
            </span>
          </div>

          <h1 className="text-amber-950" style={{ fontSize: "clamp(2.25rem, 5vw, 3.5rem)", fontWeight: 800, lineHeight: 1.15 }}>
            Screenshot a recipe.<br />
          ...
          <div className="flex items-center gap-2 pt-1">
            ...
            <span className="ml-1 text-amber-600" style={{ fontSize: "0.8125rem" }}>4.5/5 • And its completely free!</span>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="w-full max-w-sm relative">
            ...
            >
              ...
              <div className="absolute -top-2 -right-2 text-xs bg-gray-600 text-white px-2 py-0.5 rounded-full" style={{ fontSize: "0.65rem" }}>
                📸 Screenshot
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-amber-900" style={{ fontWeight: 700, fontSize: "0.875rem" }}>Focaccia</span>
                <span className="ml-auto text-xs bg-amber-100 text-amber-600 px-2 py-0.5 rounded-full" style={{ fontSize: "0.65rem", fontWeight: 600 }}>Breads</span>
              </div>
              <p className="text-amber-600 mb-1.5" style={{ fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.05em" }}>INGREDIENTS</p>
              {["500g bread flour", "7g yeast", "Olive oil", "Sea salt", "Rosemary"].map((item) => (
                <div key={item} className="flex items-center gap-1.5 mb-1">
                  <div className="w-1 h-1 rounded-full bg-amber-400 shrink-0" />
                  <span className="text-amber-800" style={{ fontSize: "0.7rem" }}>{item}</span>
                </div>
              ))}
              <p className="text-amber-600 mt-2.5 mb-1" style={{ fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.05em" }}>STEPS</p>
              {["Mix flour + yeast", "Knead 10 min", "Proof 2 hrs"].map((s, i) => (
                <div key={s} className="flex items-center gap-1.5 mb-1">
                  <div className="w-4 h-4 rounded-full bg-amber-100 flex items-center justify-center shrink-0" style={{ fontSize: "0.6rem", fontWeight: 700, color: "#92400e" }}>
                    {i + 1}
                  </div>
                  <span className="text-amber-800" style={{ fontSize: "0.7rem" }}>{s}</span>
                </div>
              ))}
              <div className="absolute -top-2 -right-2 text-xs bg-amber-400 text-amber-950 px-2 py-0.5 rounded-full" style={{ fontSize: "0.65rem", fontWeight: 700 }}>
                ✅ Saved to vault
              </div>
            </motion.div>
          </div>
