      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="md:hidden border-t border-amber-900/40 overflow-hidden" style={{ background: "#461901" }}
          >
            <div className="px-6 py-4 flex flex-col gap-4">
              {links.map((l) => (
                <a key={l} href="#" className="text-amber-200/80 hover:text-amber-100 transition-colors">
                  {l}
                </a>
              ))}
              <button className="w-full py-2.5 bg-amber-400 hover:bg-amber-500 text-amber-900 rounded-xl transition-colors" style={{ fontWeight: 600 }}>
                Get started
              </button>
            </div>
          </motion.div>
