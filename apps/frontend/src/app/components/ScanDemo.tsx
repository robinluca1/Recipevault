    ...
    <section className="py-24 px-6 bg-amber-50">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p
            className="mt-3 text-amber-700/70 max-w-lg mx-auto"
            style={{ fontSize: "1rem", lineHeight: 1.7 }}
          >
            Click through to see exactly what happens when you drop a screenshot
            into RecipeVault.
          </p>
        </motion.div>
        ...
        <div className="flex items-center justify-center gap-2 mb-10 flex-wrap">
          {steps.map((s, i) => (
            ...
            >
              <span
                className={`w-5 h-5 rounded-full flex items-center justify-center text-xs ${activeStep === i ? "bg-amber-950/20" : "bg-amber-100"}`}
          ...
          {activeStep === 0 && (
            ...
            >
              <div>
                ...
                <p
                  className="text-amber-700/70 mb-6"
                  style={{ fontSize: "0.9375rem", lineHeight: 1.7 }}
                >
                  Found a killer focaccia recipe on a food blog? Screenshot it —
                  then drag it straight into RecipeVault. We accept PNG, JPG,
                  even PDFs. Any recipe, from anywhere.
                </p>
                <ul className="flex flex-col gap-2">
                  {[
                    "Food blog screenshots",
                    "Instagram or TikTok captures",
                    "Cookbook page photos",
                    "Recipe PDFs",
                  ].map((item) => (
                    <li
                      key={item}
                      className="flex items-center gap-2.5 text-amber-800"
              ...
              <div className="bg-white border-2 border-dashed border-amber-300 rounded-3xl p-10 flex flex-col items-center justify-center gap-4 text-center">
                ...
                <div>
                  <p className="text-amber-900" style={{ fontWeight: 700 }}>
                ...
                <button
                  className="px-5 py-2 bg-amber-400 hover:bg-amber-500 text-amber-950 rounded-xl transition-colors"
                ...
                <div className="w-full border-t border-amber-100 pt-4">
                  <div className="flex items-center gap-2 bg-amber-50 rounded-xl px-3 py-2">
                    ...
                    >
                      focaccia_recipe_screenshot.png
                    </span>
                    <span
            ...
            >
              <div>
                ...
                <p
                  ...
                  style={{ fontSize: "0.9375rem", lineHeight: 1.7 }}
                >
                  Our Tesseract OCR engine scans the image line by line, then
                  our AI separates ingredients from instructions, cleans up
                  formatting, and builds a structured recipe — all in a few
                  seconds.
                </p>
                <div className="bg-amber-100/60 rounded-2xl px-5 py-4 border border-amber-200">
                  ...
                  {[
                    ...
                    "Cook time & serving size (when visible)",
                    "Recipe title from the page",
                  ].map((item) => (
              ...
              <div className="bg-white rounded-3xl border border-amber-100 shadow-md p-6 relative overflow-hidden">
                ...
                <div className="space-y-2 mb-5">
                  {["Focaccia Bread", "Ingredients", "Instructions"].map(
                    (line, i) => (
                      <motion.div
                        key={line}
                        initial={{ opacity: 0.2 }}
            ...
            >
              <div>
                ...
                <p
                  ...
                  style={{ fontSize: "0.9375rem", lineHeight: 1.7 }}
                >
                  Check the AI draft — everything is editable before saving.
                  Give the recipe a name, pick a group like <em>Breads</em> or{" "}
                  <em>Italian</em>, and optionally attach a photo of your
                  finished dish. Then it's in your vault forever.
                </p>
                <div className="flex flex-col gap-3">
                  {[
                    { label: "1. Review extracted content", icon: "🔍" },
                    {
                      label: "2. Edit anything that's off",
                    ...
                    <div
                      key={item.label}
                      className="flex items-center gap-3 bg-white rounded-xl px-4 py-3 border border-amber-100"
                    >
              ...
              <div className="bg-white rounded-3xl border border-amber-100 shadow-md p-6">
                <div className="flex items-center gap-3 mb-4 pb-4 border-b border-amber-50">
                  ...
                  <select
                    className="bg-amber-50 border border-amber-200 rounded-lg px-2 py-1 text-amber-700 outline-none text-xs"
                    defaultValue="Breads"
                  >
                ...
                <div className="space-y-1.5">
                  {extractedSteps.slice(0, 3).map((step, i) => (
                    <div key={step} className="flex items-start gap-2">
                      <span
                        className="w-4 h-4 bg-amber-100 rounded-full flex items-center justify-center shrink-0 mt-0.5"
                        style={{
                          fontSize: "0.6rem",
                          fontWeight: 700,
                          color: "#92400e",
                  ...
                  <p className="text-amber-400" style={{ fontSize: "0.75rem" }}>
                    +3 more steps…
                  </p>
                </div>

                <button
                  className="w-full mt-5 py-2.5 bg-amber-400 hover:bg-amber-500 text-amber-950 rounded-xl transition-colors"
