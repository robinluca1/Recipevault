    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-20">
        <div className="max-w-xl w-full text-center">
          ...
          <h1
            className="text-amber-900 mb-3"
            style={{ fontWeight: 800, fontSize: "2rem" }}
          >
            Welcome to RecipeVault
          </h1>
          <p
            className="text-amber-800/70 mb-10"
            style={{ fontSize: "1.0625rem" }}
          >
            Create your free account and start building your personal recipe
          ...
          <div className="grid gap-4 mb-10 text-left">
            {steps.map(({ icon: Icon, step, title, desc, note }) => (
              ...
              >
                ...
                <div>
                  <p className="text-amber-900" style={{ fontWeight: 600 }}>
                    {title}
                  </p>
                  <p
