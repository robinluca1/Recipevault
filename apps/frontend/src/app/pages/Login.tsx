        ...
        <div className="w-full max-w-sm">
          ...
          <div className="rounded-2xl border border-amber-200 bg-white/70 p-7 flex flex-col gap-5">
            ...
            >
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (touched.email)
                      setErrors(validateLogin(e.target.value, password));
                  }}
                  onBlur={() => {
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (touched.password)
                      setErrors(validateLogin(email, e.target.value));
                  }}
                  onBlur={() => {
              ...
              <button
                type="submit"
                className="w-full py-2.5 bg-amber-400 hover:bg-amber-500 text-amber-900 rounded-xl transition-colors mt-1 cursor-pointer"
